...
struct AngularInfo
{
	...
	*/
	...
	/* Yunjoo Added 2018.06.06.
	* Set values at the same time */
	void SetValues(float A1, float A2, float A3, float A4, float A5, float A6, float A7) {
		Actuator1 = A1;
		Actuator2 = A2;
		Actuator3 = A3;
		Actuator4 = A4;
...
struct FingersPosition
{
	...
	/* Yunjoo Added 2018.06.06.
	* Set values at the same time */
	void SetValues(float F1, float F2, float F3) {
		Finger1 = F1;
		Finger2 = F2;
		Finger3 = F3;
	}
