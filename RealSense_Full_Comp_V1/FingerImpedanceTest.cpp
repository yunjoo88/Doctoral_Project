...
//		float K2 = 0.28f;
//		float D2 = 0.06f;
//		float cur1 = Read2(1, 126, 2, 1);
//		float cur2 = Read2(2, 126, 2, 1);
//		if (cur1 > 2048) {
//			cur1 = cur1 - 65535;
//		}
//		if (cur2 > 2048) {
//			cur2 = cur2 - 65535;
//		}
//		cur1 = K1*(xd1 - xc1) + D1*xdot_c1 + 50;// -D*xdot_c1;
//		cur2 = K2*(xd2 - xc2) + D2*xdot_c2 + 50;// -D*xdot_c1;
//		cout << "Velocity 1 : " << xdot_c1 << endl;
//		cout << "Stiffness 1 : " << K1*(xd1 - xc1) << ", Damping 1 : " << D1*xdot_c1 << endl;
//		cout << "Velocity 2 : " << xdot_c2 << endl;
//		cout << "Stiffness 2 : " << K2*(xd2 - xc2) << ", Damping 2 : " << D2*xdot_c2 << endl;
//
...
//		cout << "Desired Position 2 " << xd2 << ", Current Position 2 " << xc2 << endl;
