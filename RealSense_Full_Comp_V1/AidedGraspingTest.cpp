...
//
//	// Read Data File
//	/*InputFile.open("LogData.txt");
//	cout << "Open Input Log File ..." << endl;
//	int InputNumLoop = 0;
//	while (~InputFile.eof()) {
//		InputData[InputNumLoop].state = 0;
//		InputData[InputNumLoop].HumanHandPos[0] = 0;
//		InputData[InputNumLoop].RobotArmPos[0] = 0;
//		InputData[InputNumLoop].RobotHandPos[0] = 0;
//		InputData[InputNumLoop].RobotHandCurrent[0] = 0;
//		InputData[InputNumLoop].RobotArmTorque[0] = 0;
//		InputData[InputNumLoop].TactileData[0] = 0;
//		InputNumLoop++;
//	}*/
//
//	// Save Data Thread
...
//	pointToSend.Position.CartesianPosition.X = currentPosition.Coordinates.X;
//	pointToSend.Position.CartesianPosition.Y = currentPosition.Coordinates.Y;
//	pointToSend.Position.CartesianPosition.Z = 0.45;
//	pointToSend.Position.CartesianPosition.ThetaX = currentPosition.Coordinates.ThetaX;
//	pointToSend.Position.CartesianPosition.ThetaY = currentPosition.Coordinates.ThetaY;
//	pointToSend.Position.CartesianPosition.ThetaZ = currentPosition.Coordinates.ThetaZ;
//	MySendBasicTrajectory(pointToSend);
...
//
//		cout << "dx : " << dx << ", dy : " << dy << ", dz : " << Down_Z << ", dth : " << dth << endl;
//
//		//int AGloopCnt = 0;
