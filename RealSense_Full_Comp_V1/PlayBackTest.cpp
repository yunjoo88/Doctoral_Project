...
//		*/
//		if (LogFile.is_open()) {
//			std::cout << "Writing Log Data... " << endl;
//			LogFile << "Saved Data in ID " << ID << "\n";
//			LogFile << "State : " << G_Mode_S << "\n";
//			LogFile << "HumanHandPos : " << LogData[ID].HumanHandPos[0] << ", " << LogData[ID].HumanHandPos[1] << ", " << LogData[ID].HumanHandPos[2] << "\n";
//			LogFile << "Gradient : " << momentum[0] << ", " << momentum[1] << ", " << momentum[2] << "\n";
//			LogFile << "RobotHandPos : " << LogData[ID].RobotHandPos[0] << ", " << LogData[ID].RobotHandPos[1] << "\n";
//			LogFile << "RobotHandCurrent : " << LogData[ID].RobotHandCurrent[0] << ", " << LogData[ID].RobotHandCurrent[1] << "\n";
//			LogFile << "RobotArmPos : " << LogData[ID].RobotArmPos[0] << ", " << LogData[ID].RobotArmPos[1] << ", "
//				<< LogData[ID].RobotArmPos[2] << ", " << LogData[ID].RobotArmPos[3] << ", "
...
//			LogFile << "GestData : " << gestdata.gest << ", " << gestdata.GestSensor[0] << ", " << gestdata.GestSensor[1]
//				<< ", " << gestdata.GestSensor[2] << ", " << gestdata.GestSensor[3] << ", " << gestdata.GestSensor[4]
//				<< ", " << gestdata.GestSensor[5] << ", " << gestdata.GestSensor[6] << ", " << gestdata.GestSensor[7] << "\n\n";
//		}
//		Sleep(500);
...
//	//	if (*(RHandPos + 1) < -0.5f) {
//	//		goal[0] = *(RHandPos);
//	//		//goal[1] = *(RHandPos+1)+0.3f;
//	//		goal[1] = 0.6f*(*(HeadPos + 1)) - (*(RHandPos + 1) - 0.6f*(*(HeadPos + 1)));
//	//		goal[2] = *(RHandPos + 2);
//	//	}
//
//	//	MyGetCartesianCommand(currentPosition);
...
//	//			MyGetCartesianCommand(currentPosition);
//	//			pointToSend.Position.CartesianPosition.X = currentPosition.Coordinates.X + momentum[0];
//	//			pointToSend.Position.CartesianPosition.Y = currentPosition.Coordinates.Y + momentum[1];
//	//			pointToSend.Position.CartesianPosition.Z = currentPosition.Coordinates.Z + momentum[2];
//	//			pointToSend.Position.CartesianPosition.ThetaX = currentPosition.Coordinates.ThetaX;
//	//			pointToSend.Position.CartesianPosition.ThetaY = currentPosition.Coordinates.ThetaY;
//	//			pointToSend.Position.CartesianPosition.ThetaZ = currentPosition.Coordinates.ThetaZ;
//
...
//	//		break;
//	//	}
//	//	case 34: case 36: case 66: case 68: case 38: case 70: case 98: case 100: case 102: {
...
//	Sleep(3000);
//
//	std::cout << "Set optimal gravity parameters." << endl;
...
//
//	// Read Data File
//	InputFile.open("LogData_Direct.txt");
//	std::cout << "Open Input Log File ..." << endl;
//	int InputNumLoop = 0;
//	
//	stringstream ss;
//	ss << InputFile.rdbuf();
...
//	char * pos = &tmppos;
//	
//	while (ss.getline(pos, 200)) {
//		//getline(ss, tmpstr);
//		
//		/*Saved Data in ID 0
//		State : 0
//		HumanHandPos : 0.02, -0.6, 0.3
//		Gradient : 0, 0, 0
//		RobotHandPos : 474, 307
//		RobotHandCurrent : 30, 49
//		RobotArmPos : -0.0247713, -0.596216, 0.448027, 1.59216, -0.0503504, 0.541865
//		RobotArmTorque : 0.00483396, -0.136157, -0.0177245, -0.0708981, -0.00563962, 0.00080566, 0.00886226
//		TactileData : 0, 0, 0, 0, 0, 0, 0, 0
//		GestData : 0, 0, 0, 0, 0, 0, 0, 0, 0*/
///*		ss.getline(pos, 100);	*/	
//		//int cntloop = atoi(strtok_s(pos, "Saved Data in ID : " , &pos));
//		//std::cout << "Count Loop : " << cntloop << endl;
//
//		ss.getline(pos, 200);
//		InputData[InputNumLoop].state = atoi(strtok_s(pos, "State : ", &pos));
//		//std::cout << "State' : " << InputData[InputNumLoop].state << endl;
//
//		ss.getline(pos, 100);		
//		InputData[InputNumLoop].HumanHandPos[0] = atof(strtok_s(pos, "HumanHandPos : ,", &pos));
//		InputData[InputNumLoop].HumanHandPos[1] = atof(strtok_s(pos, "HumanHandPos : ,", &pos));
//		InputData[InputNumLoop].HumanHandPos[2] = atof(strtok_s(pos, "HumanHandPos : ,", &pos));
//		/*std::cout << "HumanHandPos' : " << InputData[InputNumLoop].HumanHandPos[0] << ", "
//			<< InputData[InputNumLoop].HumanHandPos[1] << ", " 
//			<< InputData[InputNumLoop].HumanHandPos[2] << endl;*/
//		
//		ss.getline(pos, 200); // Gradient 생략
//
//		ss.getline(pos, 200);		
//		InputData[InputNumLoop].RobotHandPos[0] = atoi(strtok_s(pos, "RobotHandPos : ,", &pos));
//		InputData[InputNumLoop].RobotHandPos[1] = atoi(strtok_s(pos, "RobotHandPos : ,", &pos));
//		//std::cout << "RobotHandPos' : " << InputData[InputNumLoop].RobotHandPos[0] << ", "
//		//	<< InputData[InputNumLoop].RobotHandPos[1] << endl;
//
//		ss.getline(pos, 200);		
//		InputData[InputNumLoop].RobotHandCurrent[0] = atoi(strtok_s(pos, "RobotHandCurrent : ,", &pos));
//		InputData[InputNumLoop].RobotHandCurrent[1] = atoi(strtok_s(pos, "RobotHandCurrent : ,", &pos));
//	/*	std::cout << "RobotHandCurrent' : " << InputData[InputNumLoop].RobotHandCurrent[0] << ", "
//			<< InputData[InputNumLoop].RobotHandCurrent[1] << endl;*/
//
//		ss.getline(pos, 200);		
//		InputData[InputNumLoop].RobotArmPos[0] = atof(strtok_s(pos, "RobotArmPos : ,", &pos));
//		InputData[InputNumLoop].RobotArmPos[1] = atof(strtok_s(pos, "RobotArmPos : ,", &pos));
//		InputData[InputNumLoop].RobotArmPos[2] = atof(strtok_s(pos, "RobotArmPos : ,", &pos));
//		InputData[InputNumLoop].RobotArmPos[3] = atof(strtok_s(pos, "RobotArmPos : ,", &pos));
//		InputData[InputNumLoop].RobotArmPos[4] = atof(strtok_s(pos, "RobotArmPos : ,", &pos));
//		InputData[InputNumLoop].RobotArmPos[5] = atof(strtok_s(pos, "RobotArmPos : ,", &pos));
//		/*std::cout << "RobotArmPos' : " << InputData[InputNumLoop].RobotArmPos[0] << ", "
//			<< InputData[InputNumLoop].RobotArmPos[1] << ", "
//			<< InputData[InputNumLoop].RobotArmPos[2] << ", "
//			<< InputData[InputNumLoop].RobotArmPos[3] << ", "
//			<< InputData[InputNumLoop].RobotArmPos[4] << ", "
//			<< InputData[InputNumLoop].RobotArmPos[5] << endl;*/
//
//		ss.getline(pos, 200);	
//		InputData[InputNumLoop].RobotArmTorque[0] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		InputData[InputNumLoop].RobotArmTorque[1] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		InputData[InputNumLoop].RobotArmTorque[2] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		InputData[InputNumLoop].RobotArmTorque[3] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		InputData[InputNumLoop].RobotArmTorque[4] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		InputData[InputNumLoop].RobotArmTorque[5] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		InputData[InputNumLoop].RobotArmTorque[6] = atof(strtok_s(pos, "RobotArmTorque : ,", &pos));
//		/*std::cout << "RobotArmTorque' : " << InputData[InputNumLoop].RobotArmTorque[0] << ", "
//			<< InputData[InputNumLoop].RobotArmTorque[1] << ", "
//			<< InputData[InputNumLoop].RobotArmTorque[2] << ", "
//			<< InputData[InputNumLoop].RobotArmTorque[3] << ", "
//			<< InputData[InputNumLoop].RobotArmTorque[4] << ", "
//			<< InputData[InputNumLoop].RobotArmTorque[5] << ", "
//			<< InputData[InputNumLoop].RobotArmTorque[6] << endl;*/
//
//		ss.getline(pos, 200);		
//		InputData[InputNumLoop].TactileData[0] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[1] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[2] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[3] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[4] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[5] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[6] = atof(strtok_s(pos, "TactileData : ,", &pos));
//		InputData[InputNumLoop].TactileData[7] = atof(strtok_s(pos, "TactileData : ,", &pos));
//	/*	std::cout << "TactileData' : " << InputData[InputNumLoop].TactileData[0] << ", "
//			<< InputData[InputNumLoop].TactileData[1] << ", "
//			<< InputData[InputNumLoop].TactileData[2] << ", "
//			<< InputData[InputNumLoop].TactileData[3] << ", "
//			<< InputData[InputNumLoop].TactileData[4] << ", "
//			<< InputData[InputNumLoop].TactileData[5] << ", "
//			<< InputData[InputNumLoop].TactileData[6] << ", "
//			<< InputData[InputNumLoop].TactileData[7] << endl;*/
//
//		ss.getline(pos, 200); // Gest Data 생략
//		ss.getline(pos, 200);
//		 // Gest Data 생략
//
//		InputNumLoop++;
//		std::cout << InputNumLoop << endl;
//		Sleep(50);
//		//_getch();
//	}
//
...
//	LogFile.open("LogData_PB.txt");
//	std::cout << "Open Save Log File ..." << endl;
//
...
//		std::cout << "Detected " << camlist.size() << "pico camera(s)." << endl;
//
//		if (!camlist.empty())
//		{
...
//	if (status == royale::CameraStatus::SUCCESS) {
//		std::cout << " The use cases is successfully adapted to " << usecaseName << endl;
//	}
//	else {
//		std::cout << "Fail to set use case." << endl;
//	}
//
...
//										
//	if (cameraDevice->registerDataListener(&Picolistener) != royale::CameraStatus::SUCCESS) // register a data listener
//	{
...
//	// Start main loop
//	//int timeID = 0;
//	//while (timeID < InputNumLoop) {
//	//	state = InputData[timeID].state;
//	//	CartesianPosition currentPosition;
//	//	currentPosition.InitStruct();
//	//	MyGetCartesianCommand(currentPosition);
//	//	TrajectoryPoint pointToSend;
...
//	//		MySendBasicTrajectory(pointToSend);
//	//	}
//	//	else if (state == 1) { // Human Hand Position Control
//	//		goal[0] = InputData[timeID].HumanHandPos[0];
//	//		goal[1] = InputData[timeID].HumanHandPos[1];
//	//		goal[2] = InputData[timeID].HumanHandPos[2];
//	//		MyGetCartesianCommand(currentPosition);
//	//		rob_pos[0] = currentPosition.Coordinates.X;
//	//		rob_pos[1] = currentPosition.Coordinates.Y;
//	//		rob_pos[2] = currentPosition.Coordinates.Z;
...
//	//		Write2(1, 116, InputData[timeID].RobotHandPos[0], 4); // Position
//	//		Write2(2, 116, InputData[timeID].RobotHandPos[1], 4); // Position
//	//		Write2(1, 102, InputData[timeID].RobotHandCurrent[0], 2); // Position
//	//		Write2(2, 102, InputData[timeID].RobotHandCurrent[1], 2); // Position
//	//	}
//	//	else if (state == 2) { // Robot Hand Position Control + Robot Arm/Hand Current Control
//	//		// Stopped Continous Moving
//	//		GUrep_bnd[0] = 0; GUrep_bnd[1] = 0;	GUrep_bnd[2] = 0;
//	//		GUrep_obs[0] = 0; GUrep_obs[1] = 0;	GUrep_obs[2] = 0;
//	//		temp[0] = 0;	temp[1] = 0;	temp[2] = 0;
//	//		momentum[0] = 0;	momentum[1] = 0;	momentum[2] = 0;
//
//	//		pointToSend.Position.CartesianPosition.X = InputData[timeID].RobotArmPos[0];
//	//		pointToSend.Position.CartesianPosition.Y = InputData[timeID].RobotArmPos[1];
//	//		pointToSend.Position.CartesianPosition.Z = InputData[timeID].RobotArmPos[2];
//	//		pointToSend.Position.CartesianPosition.ThetaX = InputData[timeID].RobotArmPos[3];
//	//		pointToSend.Position.CartesianPosition.ThetaY = InputData[timeID].RobotArmPos[4];
//	//		pointToSend.Position.CartesianPosition.ThetaZ = InputData[timeID].RobotArmPos[5];
//	//		MySendBasicTrajectory(pointToSend);
//
//	//		// Wrist Force/Torque Sensor FB
//
//	//		// Hand Position & Current
//	//		Write2(1, 116, InputData[timeID].RobotHandPos[0], 4); // Position
//	//		Write2(2, 116, InputData[timeID].RobotHandPos[1], 4); // Position
...
//
//	//		int AGloopCnt = 0;
//	//		while (dist_err > 0.01 && AGloopCnt < 10) {
//	//			dx = d_XYZt_Kinova[0];
//	//			dy = d_XYZt_Kinova[1];
...
//	//			cout << "!!!!!!!!!!!!!!Move!!!!!!!!!!!!!!" << endl;
//	//			MyGetCartesianCommand(currentPosition);
//	//			AGloopCnt = (AGloopCnt > 6) ? 6 : AGloopCnt;
//	//			// (1.1f - countloop*0.1f) is to prevent repetitive swaying
//	//			pointToSend.Position.CartesianPosition.X = currentPosition.Coordinates.X + (1.1f - AGloopCnt*0.1f)*dx;
//	//			pointToSend.Position.CartesianPosition.Y = currentPosition.Coordinates.Y + (1.1f - AGloopCnt*0.1f)*dy;
//	//			pointToSend.Position.CartesianPosition.Z = 0.60;
//	//			pointToSend.Position.CartesianPosition.ThetaX = currentPosition.Coordinates.ThetaX;
//	//			pointToSend.Position.CartesianPosition.ThetaY = currentPosition.Coordinates.ThetaY;
//	//			pointToSend.Position.CartesianPosition.ThetaZ = currentPosition.Coordinates.ThetaZ;
//
...
//	//			
//	//			MyGetCartesianCommand(currentPosition);
//	//			dth = currentPosition.Coordinates.ThetaZ - dth; 
//
//	//			pointToSend.Position.CartesianPosition.X = currentPosition.Coordinates.X;
//	//			pointToSend.Position.CartesianPosition.Y = currentPosition.Coordinates.Y;
//	//			pointToSend.Position.CartesianPosition.Z = currentPosition.Coordinates.Z;
//	//			pointToSend.Position.CartesianPosition.ThetaX = currentPosition.Coordinates.ThetaX;
//	//			pointToSend.Position.CartesianPosition.ThetaY = currentPosition.Coordinates.ThetaY;
//	//			pointToSend.Position.CartesianPosition.ThetaZ = currentPosition.Coordinates.ThetaZ - dth;
//	//			MySendBasicTrajectory(pointToSend);
//	//			Sleep(3000);
//
//	//			std::cout << "Move to Grasping position" << endl;
//
//	//			float Down = (-Down_Z + 0.03 > -0.0) ? -Down_Z + 0.03 : -0.0;
//	//			cout << "down :" << Down << endl;
//
//	//			pointToSend.Position.CartesianPosition.X = currentPosition.Coordinates.X;
//	//			pointToSend.Position.CartesianPosition.Y = currentPosition.Coordinates.Y;
//	//			pointToSend.Position.CartesianPosition.Z = Down;
//	//			pointToSend.Position.CartesianPosition.ThetaX = currentPosition.Coordinates.ThetaX;
//	//			pointToSend.Position.CartesianPosition.ThetaY = currentPosition.Coordinates.ThetaY;
//	//			pointToSend.Position.CartesianPosition.ThetaZ = currentPosition.Coordinates.ThetaZ - dth;
//	//			MySendBasicTrajectory(pointToSend);
...
//	//			Write2(1, 102, 200, 2); // Hand Current
//	//			Write2(2, 102, 200, 2); // Hand Current
//
...
//	//		}
//	//		else {
//	//			cout << "Cannot Find Grasping Object. \n End of Program ***********************************." << endl;
//	//			return 1;
//	//		}
//	//	}
//	//	timeID++;
